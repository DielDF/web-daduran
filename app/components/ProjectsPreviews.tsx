                ...
                <div className="mt-16 grid gap-10 lg:grid-cols-[1.4fr_0.8fr] items-start">
                    ...
                    <div className="space-y-4">
                        <article className="rounded-2xl border border-zinc-800 p-6 transition hover:border-amber-400 hover:bg-zinc-900/40">
                            ...
                            <p className="mt-4 text-sm text-zinc-500"> Next.js / Node.js / TailwindCSS / Vercel </p>
                        </article>
                        <article className="rounded-2xl border border-zinc-800 p-6 transition hover:border-amber-400 hover:bg-zinc-900/40">
                            ...
                            <p className="mt-4 text-sm text-zinc-500"> Git / Java / C++ </p>
                        </article>
                        <article className="rounded-2xl border border-zinc-800 p-6 transition hover:border-amber-400 hover:bg-zinc-900/40">
                            ...
                            <p className="mt-4 text-sm text-zinc-500"> Animations / Unity / C# </p>
                        </article>
                        </div>
                    </div>
                </div>
